...
var me = {
	...
	greeter: function(firstName, state){
		return me.greeter("Hello! My name is " + firstName + "and I live in " + state)
	}
}
//////////////////PROBLEM 12////////////////////
...
var total = myNumbers.reduce(myNumbers => myNumbers + myNumbers)
...
var forTheLoveOfGeorge = notGeorge.map(e => "George")
...
var enemies = people.filter(e => (e.friend ===false))
console.log(enemies)
...
let totallyAwesome = e.reduce((acc, e) => acc + e, 0);
